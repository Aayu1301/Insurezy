...
class TopupInsuranceCopyWidget extends StatefulWidget {
  const TopupInsuranceCopyWidget({
    Key? key,
    this.emp,
    this.amount,
    this.plans,
  ...
  @override
  _TopupInsuranceCopyWidgetState createState() =>
      _TopupInsuranceCopyWidgetState();
}

class _TopupInsuranceCopyWidgetState extends State<TopupInsuranceCopyWidget> {
